...
module Decryptor #(parameter total_width=0, x_size=0, y_size=0, pck_num=0) (
        input wire clk,
        input wire rst,
...
begin
    ...
    begin
        ...
        repeat (2) @(posedge clk); // s-box pass
        ...
        inv_data[total_width-1 : x_size+y_size+pck_num] = round_data;
